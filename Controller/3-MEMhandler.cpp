...
void loadParamEEPROM(){                                           // Función que se ejecuta en el "setup()" que carga en las variables los parámetros almacenados.                                                            // Sentencia de depuración de la función en la que estamos, declarada en la pestaña "Debug.h".
...
void saveParamEEPROM(int Lmin, int Lmax, byte Cmin, byte Cmax){   // Si en algún momento queremos reescribir de golpe unos valores referencia,
  EEPROM.put(MEM_LIMIT_MIN, Lmin);                                // escribe todos en la memoria EEPROM.
